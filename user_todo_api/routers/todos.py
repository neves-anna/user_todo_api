...
from user_todo_api.models import Todo, User
...
from user_todo_api.security import get_current_user
...
def patch_todo(todo_id: int, session: T_Session, user: T_CurrentUser, todo: TodoUpdate):
